...
class PushArrive extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'push:arrive {arg1}';
     ...
     * @var string
     */
    protected $description = 'Push Arrive to user.';
    ...
    public function handle()
    {
        ...
        $message = \Lang::get('custom.push_arrive', [], $user->language);
